...
///
/// Three pushed destinations, and that is the whole list. The modal — Search — is deliberately
...
///
/// Adding a fourth case is a product change, not a refactor. `CaseIterable` is here so that
